...
if ($(".questionnaire")) {
    ...
    type_text()
    // Loops over all inputs. Adds eventListeners and listens to the changers, 
    // and adds the currently selected element to the local JSON, which gets saved in localStorage.
    type_radio()
    type_checkbox()
